...
var LRUCache = function (limit) {
  this.size = 0;
  this.items = new List();
  if(this.size > limit){ // automatically

  }
};

var LRUCacheItem = function (val, key) {
  this.item = new ListNode(null, {key: val}, null);
};
...
LRUCache.prototype.get = function (key) {
  ...
  var curr = this.items.head;
  while(curr){ // until it meets null
    // console.log(curr, curr.val, key)
    if(curr.val.val === key){
...
//
// var a = new LRUCacheItem("item1",1);
